      ...
      <div className="w-full max-w-md space-y-6">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
            Create a multi-tenant agency account in minutes
          </p>
        </div>
        ...
        <Card className="border-slate-200 shadow-sm dark:border-slate-800">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-xs">
              Fill in your agency details to establish your organization workspace.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input name="agencyName" required placeholder="Apex Marketing Group" />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <Input name="email" type="email" required placeholder="owner@agency.com" />
              </div>
              ...
              >
                ...
                Register Organization & Dashboard
              </Button>
            </form>
          </CardContent>
        </Card>
